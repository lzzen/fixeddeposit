...
$url = 'https://api.etherscan.io/v2/api?apikey=PZJEDUF4JTPHJP42UD2STHEK1YP8J25PK6&chainid=999&address='.$address.'&module=account&action=balance';
...
{
    // var_dump($data);
    $row = rendEthRow($data['result'], 'HYPE');
    ...
    <div style="position:fixed;top:5px;right:10px;text-align:right;">
        ...
        <div>
            ...
            <select id="network_select" style="padding:5px 10px;cursor:pointer;">
                ...
                <option value="999">HYPE-EVM Mainnet</option>
